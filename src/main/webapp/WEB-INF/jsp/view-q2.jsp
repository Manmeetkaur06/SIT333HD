...
<body>
<div class="card">
    <h2>Q2 - Subtraction</h2>
    <p>Enter two numbers and calculate the subtraction result.</p>
    <p class="error">${message}</p>

    <form id="q2Form" action="/q2" method="post" novalidate>
        ...
        <label for="answer">SUBTRACTION</label>
