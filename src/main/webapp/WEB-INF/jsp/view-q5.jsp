...
<body>
<div class="card">
    <h2>Q5 - Date Utility: Date Before</h2>
    <p>Enter a start date, number of days, and the date before that many days.</p>
    <p class="error">${message}</p>

    <form id="q5Form" action="/q5" method="post" novalidate>
        <label for="startDate">Start date</label>
        <input type="date" id="startDate" name="startDate">

        <label for="days">Number of days before</label>
